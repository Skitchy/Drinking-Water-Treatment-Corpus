#!/usr/bin/env python3
"""Public deterministic verifier for Ari's Foundry Pass 2 v0.2 handoff.
...
def verify_public_members(public_dir: Path, manifest):
    ...
    require(
        "control-records-v0.2.json" not in listed,
...
def main():
    ...
    manifest_path = public_dir / "ari-evaluator-public-manifest-v0.2.json"
    ...
    contract_path = public_dir / "isolated-reviewer-contract-v0.2.json"
    ...
    commitment_path = public_dir / "mixed-control-commitment-v0.2.json"
