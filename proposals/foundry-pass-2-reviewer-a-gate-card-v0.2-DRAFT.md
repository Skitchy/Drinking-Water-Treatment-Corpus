# Foundry Pass 2 — Reviewer A Clearance Gate Card v0.2 (DRAFT)
...
2. **Focused closure:** every authorized blocker refuses before a session, with a legitimate
   ...
   each lookalike is rejected, the prior command is inconsistent, and the next command is
   blocked; any deliberately untreated site is named as backlog.
...
5. **Mutation checks:** an unmutated control passes and every non-equivalent targeted mutant
   ...
   qualifying pin reruns the survivor, control, and both suites.
...
- CC technical/operational review of v0.2: **pending**
- Ari independent-review criteria: **revised under comment `18404556`; pending maintainer approval**
- Skitch final approval of v0.2: **pending**
